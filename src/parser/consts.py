import re
COMPANY_NAME_LIST = ['JPMORGAN%2520CHASE%2520%2526%2520CO%2520(JPM%252C%2520AMJ%252C%2520AMJB%252C%2520JPM)%2520(CIK%25200000019617)', 'Apple%2520Inc.%2520(AAPL)%2520(CIK%25200000320193)']
